...
- If a file produces garbled audio (common with PDFs that have lots of math/tables), note it in the summary and suggest the user clean the transcript manually before re-running with `/geno-media-audiobook-create` on that specific folder
